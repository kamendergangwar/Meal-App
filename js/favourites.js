...
function addListItemtoCard() {
  ...
  if (meal.length == 0) { //if there are no favourites 
    ...
    emptyListTag.innerHTML = `<h1>Welcome Sir! Your table is ready ! Please add some food </h1><img src="https://img.icons8.com/external-vitaliy-gorbachev-fill-vitaly-gorbachev/60/000000/external-order-food-food-delivery-vitaliy-gorbachev-fill-vitaly-gorbachev.png"height: 50% width = 50% />`;
